...
namespace UnitTest
{
    ...
    public:
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill32<0x5a, 0x20000000>()),
                {
                    0x15a1868c, 0x12cc5395, 0x1e182344, 0x277447cd, 0x0979536b, 0xadcc512a, 0xd24c67e9, 0xb2d4f3dd
                });
        }
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill32<0, 0x41000000>()),
                {
                    0x461c19a9, 0x3bd4344f, 0x9215f5ec, 0x64357090, 0x342bc66b, 0x15a14831, 0x7d276e31, 0xcbc20b53
                });
        }
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill32<0x42, 0x6000003e>()),
                {
        ...
        TEST_METHOD(A512)
        {
            ...
            Assert::AreEqual(
                sha2::sha512(fill64<0x5a, 0x20000000>()),
                {
            ...
            Assert::AreEqual(
                sha2::sha512(fill64<0, 0x41000000>()),
                {
            ...
            Assert::AreEqual(
                sha2::sha512(fill64<0x42, 0x6000003e>()),
                {
