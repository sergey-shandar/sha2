...
namespace UnitTest
{
    ...
    public:
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill_t<uint32_t, 0, 250000>()),
                {
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill_t<uint32_t, 0x5a5a5a5a, 0x8000000>()),
                {
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill_t<uint32_t, 0, 0x10400000>()),
                {
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill8<32, 0, 1000000ull * 8>()),
                {
                    0xd29751f2, 0x649b32ff, 0x572b5e0a, 0x9f541ea6, 0x60a50f94, 0xff0beedf, 0xb0b692b9, 0x24cc8025
                });
        }
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill8<32, 0x5a, 0x20000000ull * 8>()),
                {
                    0x15a1868c, 0x12cc5395, 0x1e182344, 0x277447cd, 0x0979536b, 0xadcc512a, 0xd24c67e9, 0xb2d4f3dd
                });
        }
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill8<32, 0, 0x41000000ull * 8>()),
                {
                    0x461c19a9, 0x3bd4344f, 0x9215f5ec, 0x64357090, 0x342bc66b, 0x15a14831, 0x7d276e31, 0xcbc20b53
                });
        }
        ...
        {
            Assert::AreEqual(
                sha2::sha256(fill8<32, 0x42, 0x6000003eull * 8>()),
                {
        ...
        TEST_METHOD(A512)
        {
            ...
            Assert::AreEqual(
                sha2::sha512(fill8<64, 0x41, 1000 * 8>()),
                {
            ...
            Assert::AreEqual(
                sha2::sha512(fill8<64, 0x55, 1005 * 8>()),
                {
            ...
            Assert::AreEqual(
                sha2::sha512(fill8<64, 0, 1000000 * 8>()),
                {
            ...
            Assert::AreEqual(
                sha2::sha512(fill8<64, 0x5a, 0x20000000ull * 8>()),
                {
            ...
            Assert::AreEqual(
                sha2::sha512(fill8<64, 0, 0x41000000ull * 8>()),
                {
            ...
            Assert::AreEqual(
                sha2::sha512(fill8<64, 0x42, 0x6000003eull * 8>()),
                {
