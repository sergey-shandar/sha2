...
namespace UnitTest
{
    ...
    public:
        ...
        {
            Assert::AreEqual(
                sha2::sha256(no_remainder(nrange_t<uint32_t, 0, 250000>())),
                {
        ...
        {
            Assert::AreEqual(
                sha2::sha256(no_remainder(nrange_t<uint32_t, 0x5a5a5a5a, 0x8000000>())),
                {
        ...
        {
            Assert::AreEqual(
                sha2::sha256(no_remainder(nrange_t<uint32_t, 0, 0x10400000>())),
                {
